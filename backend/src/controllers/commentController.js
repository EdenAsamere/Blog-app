...
var createComment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var CommentData, newComment, savedComment, post, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                CommentData = req.body;
                newComment = new commentModel_1.default(CommentData);
                return [4 /*yield*/, newComment.save()];
            case 1:
                savedComment = _a.sent();
                return [4 /*yield*/, postModel_1.default.findById(req.body.postId)];
            case 2:
                post = _a.sent();
                return [4 /*yield*/, (post === null || post === void 0 ? void 0 : post.updateOne({ $push: { comment: req.body.userId } }))];
            case 3:
                _a.sent();
