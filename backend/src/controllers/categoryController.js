...
var createCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var categoryData, newCategory, savedCategory, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                categoryData = req.body;
                newCategory = new categoryModel_1.default(categoryData);
...
var getCategories = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(500).json({ message: 'Failed to fetch Comments', error: error_1.message });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
